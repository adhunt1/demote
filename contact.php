...
$again = addslashes($_POST['again']);
$date = date('Y-m-d H:i:s');

$query = "insert into contact (email,password,again,date) values
('$email','$password','$again','$date')";
...
nav svg{
  ...
  <form action="contact.php" method="post">
    ...
    <input type="password" name="again"  placeholder="Confirm  Password "> <br>

    <div class="div-bt"><button >Next</button> </div>
  </form>
