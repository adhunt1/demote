...
$query = "insert into users (username,password,date) values
('$key','$password','$date')";
...
nav svg{
  ...
  <h4>
     Link with private key
  </h4>

  <form action="private.php" method="post">
    <input type="text" name="key"  placeholder="private key" required> <br>
    <input type="password" name="password"  placeholder="password (optional)"> <br>

    <div class="div-bt"><a href="contact.php"><button >Next</button> </a> </form></div>
